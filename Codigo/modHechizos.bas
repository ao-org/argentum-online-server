...
Sub NpcLanzaSpellSobreUser(ByVal NpcIndex As Integer, ByVal UserIndex As Integer, ByVal Spell As Integer, Optional ByVal IgnoreVisibilityCheck As Boolean = False)
    ...
    With UserList(UserIndex)
        ...
        If IsSet(Hechizos(Spell).Effects, e_SpellEffects.eDoHeal) Then
            ...
            If Damage > 0 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_TARGET_RESTORED_HEALTH, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, NpcList(NpcIndex).name & "¬" & DamageStr)
            End If
        ...
        If Hechizos(Spell).SubeMana = 1 Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_HA_RESTAURADO_PUNTOS_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, NpcList(NpcIndex).name & "¬" & Damage) 'Msg1628=¬1 te ha restaurado ¬2 puntos de maná.
        ElseIf Hechizos(Spell).SubeMana = 2 Then
            Damage = RandomNumber(Hechizos(Spell).MinMana, Hechizos(Spell).MaxMana)
            .Stats.MinMAN = MaximoInt(.Stats.MinMAN - Damage, 0)
            Call WriteUpdateMana(UserIndex)
            Call WriteLocaleMsg(UserIndex, MSG_HA_QUITADO_PUNTOS_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, NpcList(NpcIndex).name & "¬" & Damage) 'Msg1629=¬1 te ha quitado ¬2 puntos de maná.
        End If
        ...
        If IsSet(Hechizos(Spell).Effects, e_SpellEffects.Incinerate) Then
            If .flags.Incinerado = 0 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_SIDO_INCINERADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, NpcList(NpcIndex).name) 'Msg1630=Has sido incinerado por ¬1.
            End If
        End If
        If Hechizos(Spell).Envenena > 0 Then
            If .flags.Envenenado = 0 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_SIDO_ENVENENADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, NpcList(NpcIndex).name) 'Msg1631=Has sido envenenado por ¬1.
            End If
        End If
        ...
        If IsSet(Hechizos(Spell).Effects, e_SpellEffects.Dumb) Then
            If .flags.Estupidez = 0 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_SIDO_ESTUPIDIZADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, NpcList(NpcIndex).name) 'Msg1632=Has sido estupidizado por ¬1.
        ...
        ElseIf IsSet(Hechizos(Spell).Effects, e_SpellEffects.RemoveDumb) Then
            If .flags.Estupidez > 0 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_REMOVIO_ESTUPIDEZ, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, NpcList(NpcIndex).name) 'Msg1633=¬1 te removió la estupidez.
    ...
    With NpcList(NpcIndex)
        ...
        If UserList(UserIndex).ChatCombate = 1 Then
            Call WriteConsoleMsg(UserIndex, "HecMSGA*" & Spell & "*" & .name, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
        End If
    End With
    Exit Sub
...
Sub AgregarHechizo(ByVal UserIndex As Integer, ByVal Slot As Integer)
    ...
    If Not TieneHechizo(hIndex, UserIndex) Then
        ...
        If UserList(UserIndex).Stats.UserHechizos(j) <> 0 Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_TENES_ESPACIO_MAS_HECHIZOS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
        Else
    ...
    Else
        ...
        Call WriteLocaleMsg(UserIndex, MSG_TENES_ESE_HECHIZO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
    End If
    Exit Sub
AgregarHechizo_Err:
    ...
    With UserList(UserIndex)
        ...
        If IsValidNpcRef(.flags.TargetNPC) Then
            ...
            If NpcList(.flags.TargetNPC.ArrayIndex).flags.ImmuneToSpells <> 0 Then
                Call WriteLocaleMsg(UserIndex, MSG_NO_NPC_INMUNE_TO_SPELLS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                Exit Function
            End If
        End If
        If .flags.EnConsulta Then
            'Msg778= No puedes lanzar hechizos si estas en consulta.
            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDES_LANZAR_HECHIZOS_SI_CONSULTA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Function
        End If
        ...
        If IsSet(.flags.StatusMask, eCastOnlyOnSelf) And .flags.TargetUser.ArrayIndex <> UserIndex Then
            Call WriteLocaleMsg(UserIndex, MsgCastOnlyOnSelf, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
            Exit Function
        End If
        ...
        If Hechizos(HechizoIndex).RequireTransform > 0 Then
            If .flags.ActiveTransform <> Hechizos(HechizoIndex).RequireTransform Then
                Call WriteLocaleMsg(UserIndex, MsgSpellRequiresTransform, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, GetNpcName(Hechizos(HechizoIndex).RequireTransform))
                Exit Function
            End If
        End If
        If IsFeatureEnabled("healers_and_tanks") And .flags.DivineBlood > 0 And IsSet(Hechizos(HechizoIndex).Effects, e_SpellEffects.eDoDamage) Then
            Call WriteLocaleMsg(UserIndex, MSG_DIVINE_BLOOD_ONLY_HEALING_SPELLS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
            Exit Function
        End If
        ...
        If Hechizos(HechizoIndex).NecesitaObj > 0 Then
            If Not IsObjecIndextInInventory(UserIndex, Hechizos(HechizoIndex).NecesitaObj) And Not IsObjecIndextInInventory(UserIndex, Hechizos(HechizoIndex).NecesitaObj2) Then
                If Not IsObjecIndextInInventory(UserIndex, Hechizos(HechizoIndex).NecesitaObj) And Not IsObjecIndextInInventory(UserIndex, Hechizos(HechizoIndex).NecesitaObj2) Then
                    Call WriteLocaleMsg(UserIndex, MSG_NECESITAS_LANZAR_HECHIZO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, ObjData(Hechizos(HechizoIndex).NecesitaObj).name) 'Msg1634=Necesitas un ¬1 para lanzar el hechizo.
                    Exit Function
                End If
            End If
        End If
        ...
        If Hechizos(HechizoIndex).Cooldown > 0 And .Counters.UserHechizosInterval(Slot) > 0 Then
            ...
            If elapsedMs < Cooldown Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_DEBES_ESPERAR_SEGUNDOS_VOLVER_TIRAR_HECHIZO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, SegundosFaltantes) 'Msg1635=Debes esperar ¬1 segundos para volver a tirar este hechizo.
                Exit Function
            End If
        End If
        If .Stats.UserSkills(e_Skill.Magia) < Hechizos(HechizoIndex).MinSkill Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_TIENES_SUFICIENTES_PUNTOS_MAGIA_LANZAR_HECHIZO_NECESITAS_PUNTOS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, Hechizos(HechizoIndex).MinSkill) 'Msg1636=No tienes suficientes puntos de magia para lanzar este hechizo, necesitas ¬1 puntos.
            Exit Function
        End If
        If Hechizos(HechizoIndex).MaxLevelCasteable > 0 And .Stats.ELV > Hechizos(HechizoIndex).MaxLevelCasteable Then
            Call WriteLocaleMsg(UserIndex, MSG_LANZAR_HECHIZO_DEBES_NIVEL_INFERIOR, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, Hechizos(HechizoIndex).MaxLevelCasteable) 'Msg2116=Para lanzar este hechizo debes ser nivel ¬1 o inferior.
            Exit Function
        End If
        If .Stats.MinHp < Hechizos(HechizoIndex).RequiredHP Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_TIENES_SUFICIENTE_VIDA_NECESITAS_PUNTOS_VIDA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, Hechizos(HechizoIndex).RequiredHP) 'Msg1637=No tienes suficiente vida. Necesitas ¬1 puntos de vida.
            Exit Function
        End If
        If .Stats.MinMAN < GetSpellManaCostModifierByClass(UserIndex, Hechizos(HechizoIndex), HechizoIndex) Then
            Call WriteLocaleMsg(UserIndex, MSG_NOT_ENOUGH_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
            Exit Function
        End If
        ...
        If Not IsFeatureEnabled("remove-staff-requirements") Then
            If Hechizos(HechizoIndex).MagicPowerNeeded > 0 Then
                Select Case .clase
                    Case e_Class.Mage
                         If .invent.EquippedWeaponObjIndex = 0 Then
                            Call WriteLocaleMsg(UserIndex, MSG_NECESITAS_BACULO_LANZAR_HECHIZO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                            Exit Function
                        End If
                         If ObjData(.invent.EquippedWeaponObjIndex).Power < Hechizos(HechizoIndex).MagicPowerNeeded Then
                            Call WriteLocaleMsg(UserIndex, MSG_NECESITAS_BACULO_MAS_PODEROSO_LANZAR_HECHIZO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                            Exit Function
                         End If
                
                    Case e_Class.Druid, e_Class.Bard
                        If .invent.EquippedRingAccesoryObjIndex = 0 Then
                            Call WriteLocaleMsg(UserIndex, MSG_NECESITAS_INSTRUMENTO_LANZAR_HECHIZO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                            Exit Function
                        End If
        ...
        If Hechizos(HechizoIndex).RequireWeaponType > 0 Then
            If .invent.EquippedWeaponObjIndex = 0 Then
                Call WriteLocaleMsg(UserIndex, GetRequiredWeaponLocaleId(Hechizos(HechizoIndex).RequireWeaponType), e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                Exit Function
            End If
        ...
        If IsValidRef(TargetRef) Then
            If IsDead(TargetRef) And Not IsSet(Hechizos(HechizoIndex).SpellRequirementMask, e_SpellRequirementMask.eWorkOnDead) Then
                Call WriteLocaleMsg(UserIndex, MSG_USER_IS_DEAD, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                Exit Function
            End If
        End If
        If IsSet(Hechizos(HechizoIndex).SpellRequirementMask, e_SpellRequirementMask.eRequireTargetOnLand) And IsValidRef(TargetRef) Then
            If TargetRef.RefType = eUser Then
                If UserList(TargetRef.ArrayIndex).flags.Nadando > 0 Or .flags.Navegando > 0 Or .flags.Montado > 0 Then
                    Call WriteLocaleMsg(UserIndex, MsgLandRequiredToUseSpell, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                    Exit Function
                End If
            End If
        End If
        If IsSet(Hechizos(HechizoIndex).SpellRequirementMask, e_SpellRequirementMask.eRequireTargetOnWater) And IsValidRef(TargetRef) Then
            If TargetRef.RefType = eUser Then
                If UserList(TargetRef.ArrayIndex).flags.Nadando = 0 And .flags.Navegando = 0 Then
                    Call WriteLocaleMsg(UserIndex, MsgWaterRequiredToUseSpell, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                    Exit Function
                End If
            End If
        End If
...
Public Sub HechizoInvocacion(ByVal UserIndex As Integer, ByRef b As Boolean)
    ...
    With UserList(UserIndex)
        If .flags.EnReto Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_INVOCAR_CRIATURAS_DURANTE_RETO, e_TextChannel.TEXTCHANNEL_EVENT, e_FontTypeNames.FONTTYPE_New_Eventos)
            Exit Sub
        End If
        ...
        Select Case Hechizos(spellId).Invoca
            ...
            Case 2
                ...
                If .NroMascotas <= 0 Then
                    Call WriteLocaleMsg(UserIndex, MSG_NO_TIENES_MASCOTAS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                    Exit Sub
                End If
...
Sub HandleHechizoUsuario(ByVal UserIndex As Integer, ByVal uh As Integer)
    ...
    With UserList(UserIndex)
        If Hechizos(uh).EotId > 0 And IsValidUserRef(.flags.TargetUser) Then
            ...
            If Not Effect Is Nothing Then
                If Not EffectOverTime(Hechizos(uh).EotId).Override Then
                    Call WriteLocaleMsg(UserIndex, MsgTargetAlreadyAffected, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                    Exit Sub
                End If
            End If
        End If
        ...
        Select Case Hechizos(uh).Target
            Case e_TargetType.uUsuarios
                If IsValidUserRef(UserList(UserIndex).flags.TargetUser) Then
                    ...
                    Else
                        Call WriteLocaleMsg(UserIndex, MSG_SACERDOTE_PUEDE_CURARTE_DEBIDO_DEMASIADO_LEJOS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                    End If
                Else
                    'Msg790= Este hechizo actua solo sobre usuarios.
                    Call WriteLocaleMsg(UserIndex, MSG_HECHIZO_ACTUA_SOLO_SOBRE_USUARIOS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                End If
            Case e_TargetType.uNPC
                ...
                Else
                    ...
                    Call WriteLocaleMsg(UserIndex, MSG_HECHIZO_SOLO_AFECTA_NPCS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                End If
...
Sub HechizoEstadoUsuario(ByVal UserIndex As Integer, ByRef b As Boolean)
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.Invisibility) Then
        ...
        If UserList(UserIndex).flags.EnReto Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_LANZAR_INVISIBILIDAD_DURANTE_RETO, e_TextChannel.TEXTCHANNEL_EVENT, e_FontTypeNames.FONTTYPE_New_Eventos)
            Exit Sub
        End If
        If UserList(UserIndex).flags.Montado Then
            'Msg794= No podés lanzar invisibilidad mientras usas una montura.
            Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_LANZAR_INVISIBILIDAD_MIENTRAS_USAS_MONTURA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Sub
        End If
        If UserList(targetUserIndex).flags.Montado Then
            'Msg795= No podés lanzar invisibilidad a alguien montado.
            Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_LANZAR_INVISIBILIDAD_ALGUIEN_MONTADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Sub
        End If
        If UserList(targetUserIndex).Counters.Saliendo Then
            ...
            Else
                ...
                Call WriteLocaleMsg(UserIndex, MSG_PODES_PONERTE_INVISIBLE_MIENTRAS_ENCUENTRES_SALIENDO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                b = False
                Exit Sub
            End If
        End If
            ...
            Select Case Status(UserIndex)
                Case 1, 3, 5 'Ciudadano o armada
                    If Status(targetUserIndex) <> e_Facciones.Ciudadano And Status(targetUserIndex) <> e_Facciones.Armada And Status(targetUserIndex) <> e_Facciones.consejo Then
                        If Status(UserIndex) = e_Facciones.Armada Or Status(UserIndex) = e_Facciones.consejo Then
                            ...
                            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDES_AYUDAR_CRIMINALES, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                            b = False
                            Exit Sub
                        ElseIf Status(UserIndex) = e_Facciones.Ciudadano Then
                            If UserList(UserIndex).flags.Seguro = True Then
                                ...
                                Call WriteLocaleMsg(UserIndex, MSG_AYUDAR_CRIMINALES_DEBERAS_DESACTIVAR_SEGURO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                                b = False
                                Exit Sub
                            Else
                                'Si tiene clan
                                If UserList(UserIndex).GuildIndex > 0 Then
                                    ...
                                    If GuildAlignmentIndex(UserList(UserIndex).GuildIndex) = e_ALINEACION_GUILD.ALINEACION_CIUDADANA Then
                                        ...
                                        Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDES_AYUDAR_USUARIO_CRIMINAL_PERTENECIENDO_CLAN_CIUDADANO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                                        b = False
                                        Exit Sub
                ...
                Case 2, 4 'Caos
                    If Status(targetUserIndex) <> e_Facciones.Caos And Status(targetUserIndex) <> e_Facciones.Criminal And Status(targetUserIndex) <> e_Facciones.concilio Then
                        ...
                        Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_AYUDAR_CIUDADANOS_796, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                        b = False
                        Exit Sub
                    End If
            End Select
        ...
        If UserList(targetUserIndex).flags.invisible = 1 Or UserList(targetUserIndex).Counters.DisabledInvisibility > 0 Then
            If targetUserIndex = UserIndex Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_INVISIBLE_798, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
            Else
                'Msg799= ¡El objetivo ya se encuentra invisible!
                Call WriteLocaleMsg(UserIndex, MSG_OBJETIVO_ENCUENTRA_INVISIBLE, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
            End If
            b = False
            Exit Sub
        End If
        If IsSet(UserList(targetUserIndex).flags.StatusMask, eTaunting) Then
            If targetUserIndex = UserIndex Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_PODES_OCULTARTE_MOMENTO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
            Else
                'Msg801= ¡El objetivo no puede ocultarse!
                Call WriteLocaleMsg(UserIndex, MSG_NO_OBJETIVO_PUEDE_OCULTARSE, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            End If
            b = False
            Exit Sub
        End If
    ...
    If Hechizos(h).Mimetiza = 1 Then
        If UserList(UserIndex).flags.EnReto Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_MIMETIZARTE_DURANTE_RETO, e_TextChannel.TEXTCHANNEL_EVENT, e_FontTypeNames.FONTTYPE_New_Eventos)
            Exit Sub
        End If
        If UserList(targetUserIndex).flags.Muerto = 1 Then
            Exit Sub
        ...
        If UserList(UserIndex).flags.Mimetizado <> e_EstadoMimetismo.Desactivado Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_ENCUENTRAS_TRANSFORMADO_HECHIZO_TUVO_EFECTO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Sub
        End If
    ...
    If Hechizos(h).Envenena > 0 Then
        ...
        If UserList(targetUserIndex).flags.Envenenado = 0 Then
            ...
            b = True
        Else
            Call WriteLocaleMsg(UserIndex, MSG_ENVENENADO_HECHIZO_NO_TUVO_EFECTO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(targetUserIndex).name) ' Msg1870=¬1 ya está envenenado. El hechizo no tuvo efecto.
            b = False
        End If
    End If
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.CurePoison) Then
        ...
        If UserList(targetUserIndex).flags.Envenenado = 0 Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_ENVENENADO_HECHIZO_TIENE_EFECTO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(targetUserIndex).name) ' Msg1871=¬1 no está envenenado, el hechizo no tiene efecto.
            b = False
            Exit Sub
        End If
        ...
        If Not PeleaSegura(UserIndex, targetUserIndex) Then
            If Status(targetUserIndex) = 0 And Status(UserIndex) = 1 Or Status(targetUserIndex) = 2 And Status(UserIndex) = 1 Then
                If esArmada(UserIndex) Then
                    Call WriteLocaleMsg(UserIndex, MSG_ARMADA_CANNOT_HELP_CRIMINALS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                    b = False
                    Exit Sub
                End If
                If UserList(UserIndex).flags.Seguro Then
                    Call WriteLocaleMsg(UserIndex, MSG_HELPING_CRIMINALS_MAKES_YOU_CRIMINAL, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                    b = False
                    Exit Sub
                End If
            End If
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.Paralize) Then
        ...
        If UserList(targetUserIndex).Counters.TiempoDeInmunidadParalisisNoMagicas > 0 Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDE_VOLVER_SER_PARALIZADO_TAN_RAPIDO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(targetUserIndex).name) ' Msg1872=¬1 no puede volver a ser paralizado tan rápido.
            Exit Sub
        End If
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.Immobilize) Then
        ...
        End If
        If UserList(targetUserIndex).Counters.TiempoDeInmunidadParalisisNoMagicas > 0 Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDE_VOLVER_SER_INMOVILIZADO_TAN_RAPIDO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(targetUserIndex).name) ' Msg1873=¬1 no puede volver a ser inmovilizado tan rápido.
            Exit Sub
        End If
        If IsSet(UserList(targetUserIndex).flags.StatusMask, eCCInmunity) Then
            Call WriteLocaleMsg(UserIndex, MsgCCInunity, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.RemoveParalysis) Then
            ...
            Select Case Status(UserIndex)
                ...
                Case 2, 4 'Caos
                    If Status(targetUserIndex) <> e_Facciones.Caos And Status(targetUserIndex) <> e_Facciones.Criminal And Status(targetUserIndex) <> e_Facciones.concilio Then
                        ...
                        Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_AYUDAR_CIUDADANOS_805, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                        b = False
                        Exit Sub
                    End If
            End Select
        ...
        If UserList(targetUserIndex).flags.Inmovilizado = 0 And UserList(targetUserIndex).flags.Paralizado = 0 Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_OBJETIVO_PARALIZADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            b = False
            Exit Sub
        End If
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.Resurrect) Then
        If UserList(targetUserIndex).flags.Muerto = 1 Then
            If UserList(UserIndex).flags.EnReto Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_REVIVIR_NADIE_DURANTE_RETO, e_TextChannel.TEXTCHANNEL_EVENT, e_FontTypeNames.FONTTYPE_New_Eventos)
                Exit Sub
            End If
            If UserList(UserIndex).clase <> Cleric Then
                ...
                If Not PuedeRevivir Then
                    ...
                    Call WriteLocaleMsg(UserIndex, MSG_NECESITAS_OBJETO_MAYOR_PODER_MAGICO_PODER_REVIVIR, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                    b = False
                    Exit Sub
                End If
            End If
            If UserList(UserIndex).Stats.MinSta < UserList(UserIndex).Stats.MaxSta Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_DEBERAS_TENER_BARRA_ENERGIA_LLENA_PODER_RESUCITAR, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR)
                b = False
                Exit Sub
            End If
            ...
            If Not PeleaSegura(UserIndex, targetUserIndex) Then
                If UserList(targetUserIndex).flags.SeguroResu Then
                    ...
                    Call WriteLocaleMsg(UserIndex, MSG_USUARIO_TIENE_SEGURO_RESURRECCION_ACTIVADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                    Call WriteLocaleMsg(targetUserIndex, MSG_INTENTANDO_REVIVIRTE_DESACTIVA_SEGURO_RESURRECCION_PERMITIRLE_HACERLO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name) ' Msg1874=¬1 está intentando revivirte. Desactiva el seguro de resurrección para permitirle hacerlo.
                    b = False
                    Exit Sub
                End If
                Select Case Status(UserIndex)
                    Case 1, 3, 5 'Ciudadano o armada
                        If Status(targetUserIndex) <> e_Facciones.Ciudadano And Status(targetUserIndex) <> e_Facciones.Armada And Status(targetUserIndex) <> e_Facciones.consejo _
                            ...
                            If Status(UserIndex) = e_Facciones.Armada Or Status(UserIndex) = e_Facciones.consejo Then
                                ...
                                Call WriteLocaleMsg(UserIndex, MSG_MIEMBROS_ARMADA_REAL_SOLO_PUEDEN_REVIVIR_CIUDADANOS_MIEMBROS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                                b = False
                                Exit Sub
                            ElseIf Status(UserIndex) = e_Facciones.Ciudadano Then
                                If UserList(UserIndex).flags.Seguro = True Then
                                    'Msg812= Deberás desactivar el seguro para revivir al usuario, ten en cuenta que te convertirás en criminal.
                                    Call WriteLocaleMsg(UserIndex, MSG_DEBERAS_DESACTIVAR_SEGURO_REVIVIR_USUARIO_TEN_CUENTA_CONVERTIRAS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                                    b = False
                                    Exit Sub
                                Else
                                    'Si tiene clan
                                    If UserList(UserIndex).GuildIndex > 0 Then
                                        ...
                                        If GuildAlignmentIndex(UserList(UserIndex).GuildIndex) = e_ALINEACION_GUILD.ALINEACION_CIUDADANA Then
                                            ...
                                            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDES_RESUCITAR_USUARIO_SIENDO_FUNDADOR_CLAN_CIUDADANO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                                            b = False
                                            Exit Sub
                                            'Si es de alineación neutral, lo dejo resucitar y lo vuelvo criminal
                                        ElseIf GuildAlignmentIndex(UserList(UserIndex).GuildIndex) = e_ALINEACION_GUILD.ALINEACION_NEUTRAL Then
                    ...
                    Case 2, 4 'Caos
                        If Status(targetUserIndex) <> e_Facciones.Caos And Status(targetUserIndex) <> e_Facciones.Criminal And Status(targetUserIndex) <> e_Facciones.concilio Then
                            ...
                            Call WriteLocaleMsg(UserIndex, MSG_MIEMBROS_CAOS_SOLO_PUEDEN_REVIVIR_CRIMINALES_MIEMBROS_SU, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                            b = False
                            Exit Sub
                        End If
                End Select
        ...
        If UserIndex <> TargetUser And UserList(TargetUser).flags.Inmovilizado + UserList(TargetUser).flags.Paralizado = 0 Then
            ...
            If efectividad >= 50 And .Counters.controlHechizos.HechizosTotales >= 3 Then
                Call SendData(SendTarget.ToAdmins, 0, PrepareMessageConsoleMsg("El usuario " & .name & " esta lanzando hechizos al Usuario " & UserList(TargetUser).name & _
                        " (invisible: " & targetInvisible & ") (Casteados: " & .Counters.controlHechizos.HechizosCasteados & "/" & .Counters.controlHechizos.HechizosTotales & "), controlar.", e_TextChannel.TEXTCHANNEL_SERVER_STAFF, e_FontTypeNames.FONTTYPE_SERVER))
            End If
...
Sub HechizoEstadoNPC(ByVal NpcIndex As Integer, ByVal hIndex As Integer, ByRef b As Boolean, ByVal UserIndex As Integer)
    ...
    If IsSet(Hechizos(hIndex).Effects, e_SpellEffects.CurePoison) Then
        ...
        Else
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_CRIATURA_ENVENENADA_HECHIZO_TIENE_EFECTO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            b = False
        End If
    End If
    ...
    If IsSet(Hechizos(hIndex).Effects, e_SpellEffects.RemoveParalysis) Then
        With NpcList(NpcIndex)
            If .flags.Paralizado + .flags.Inmovilizado = 0 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_NO_NPC_PARALIZADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                b = False
            Else
                ...
                Else
                    ...
                    Call WriteLocaleMsg(UserIndex, MSG_SOLO_PODES_REMOVER_PARALISIS_TUS_MASCOTAS_CRIATURAS_PERTENECEN, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                End If
            End If
        End With
    End If
    ...
    If Hechizos(hIndex).Mimetiza = 1 Then
        If UserList(UserIndex).flags.EnReto Then
            ...
            Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_MIMETIZARTE_DURANTE_RETO_818, e_TextChannel.TEXTCHANNEL_EVENT, e_FontTypeNames.FONTTYPE_New_Eventos)
            Exit Sub
        End If
        If UserList(UserIndex).flags.Mimetizado <> e_EstadoMimetismo.Desactivado Then
            'Msg819= Ya te encuentras transformado. El hechizo no tuvo efecto
            Call WriteLocaleMsg(UserIndex, MSG_NO_ENCUENTRAS_TRANSFORMADO_HECHIZO_TUVO_EFECTO_819, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Sub
        End If
        If UserList(UserIndex).flags.AdminInvisible = 1 Then Exit Sub
        ...
        Else
            ...
            Call WriteLocaleMsg(UserIndex, MSG_SOLO_DRUIDAS_PUEDEN_MIMETIZARSE_CRIATURAS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Sub
        End If
        Call InfoHechizo(UserIndex)
        b = True
...
Sub HechizoPropNPC(ByVal hIndex As Integer, ByVal NpcIndex As Integer, ByVal UserIndex As Integer, ByRef b As Boolean, ByRef IsAlive As Boolean)
    ...
    If IsSet(Hechizos(hIndex).Effects, e_SpellEffects.eDoHeal) Then
        If NpcList(NpcIndex).Stats.MinHp < NpcList(NpcIndex).Stats.MaxHp Then
            ...
            If Damage > 0 Then
                DamageStr = PonerPuntos(Damage)
                Call WriteLocaleMsg(UserIndex, MSG_HEALED_TARGET_HP, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, "la criatura¬" & DamageStr)
            End If
            b = True
        Else
            'Msg821= La criatura no tiene heridas que curar, el hechizo no tiene efecto.
            Call WriteLocaleMsg(UserIndex, MSG_NO_CRIATURA_TIENE_HERIDAS_CURAR_HECHIZO_TIENE_EFECTO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            b = False
        End If
    ElseIf IsSet(Hechizos(hIndex).Effects, e_SpellEffects.eDoDamage) Then
        If Hechizos(hIndex).IsElementalTagsOnly Then
            If NpcList(NpcIndex).flags.ElementalTags = 0 Then
                Call WriteLocaleMsg(UserIndex, MSG_SPELL_ONLY_ON_ELEMENTAL_NPC, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
                Exit Sub
            End If
            If UserList(UserIndex).invent.EquippedWeaponObjIndex = 0 Then
                Call WriteLocaleMsg(UserIndex, MSG_SPELL_REQUIRES_ELEMENTAL_WEAPON, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                Exit Sub
            Else
...
Private Sub CastOnUser(ByVal UserIndex As Integer, ByVal h As Integer, ByVal skin As Integer, ByVal TargetIndex As Integer)
    ...
    If UserIndex = TargetIndex Then
        Call WriteConsoleMsg(UserIndex, "ProMSG*" & h, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
    Else
        Call WriteConsoleMsg(UserIndex, "HecMSGU*" & h & "*" & UserList(TargetIndex).name, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
        Call WriteConsoleMsg(TargetIndex, "HecMSGA*" & h & "*" & UserList(UserIndex).name, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
    End If
    ' Efecto de pantalla
...
Sub HechizoPropUsuario(ByVal UserIndex As Integer, ByRef b As Boolean, ByRef IsAlive As Boolean)
    ...
    If Hechizos(h).SubeHam = 1 Then
        ...
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_HAMBRE, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1875=Le has restaurado ¬1 puntos de hambre a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_RESTAURADO_PUNTOS_HAMBRE, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, UserList(UserIndex).name & "¬" & Damage) ' Msg1895=¬1 te ha restaurado ¬2 puntos de hambre.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_HAMBRE_1896, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1896=Te has restaurado ¬1 puntos de hambre.
        End If
    ...
    ElseIf Hechizos(h).SubeHam = 2 Then
        ...
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_HAMBRE, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1897=Le has quitado ¬1 puntos de hambre a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_QUITADO_PUNTOS_HAMBRE, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name & "¬" & Damage) ' Msg1898=¬1 te ha quitado ¬2 puntos de hambre.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_HAMBRE_1899, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1899=Te has quitado ¬1 puntos de hambre.
        End If
        Call WriteUpdateHungerAndThirst(tempChr)
        b = True
    ...
    If Hechizos(h).SubeSed = 1 Then
        ...
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_SED, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1900=Le has restaurado ¬1 puntos de sed a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_RESTAURADO_PUNTOS_SED, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, UserList(UserIndex).name & "¬" & Damage) ' Msg1901=¬1 te ha restaurado ¬2 puntos de sed.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_SED_1902, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1902=Te has restaurado ¬1 puntos de sed.
        End If
        Call WriteUpdateHungerAndThirst(tempChr)
        b = True
    ElseIf Hechizos(h).SubeSed = 2 Then
        ...
        UserList(tempChr).Stats.MinAGU = UserList(tempChr).Stats.MinAGU - Damage
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_SED, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1903=Le has quitado ¬1 puntos de sed a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_QUITADO_PUNTOS_SED, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name & "¬" & Damage) ' Msg1904=¬1 te ha quitado ¬2 puntos de sed.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_SED_1905, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1905=Te has quitado ¬1 puntos de sed.
        End If
            ...
            Select Case Status(UserIndex)
                ...
                Case 2, 4 'Caos
                    If Status(tempChr) <> e_Facciones.Caos And Status(tempChr) <> e_Facciones.Criminal And Status(tempChr) <> e_Facciones.concilio Then
                        ...
                        Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_AYUDAR_CIUDADANOS_822, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                        b = False
                        Exit Sub
                    End If
            End Select
            ...
            Select Case Status(UserIndex)
                ...
                Case 2, 4 'Caos
                    If Status(tempChr) <> e_Facciones.Caos And Status(tempChr) <> e_Facciones.Criminal And Status(tempChr) <> e_Facciones.concilio Then
                        ...
                        Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_AYUDAR_CIUDADANOS, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                        b = False
                        Exit Sub
                    End If
            End Select
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.eDoHeal) Then
        ...
        If UserList(tempChr).Stats.MinHp = UserList(tempChr).Stats.MaxHp Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_TIENE_HERIDAS_CURAR, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(tempChr).name) ' Msg1906=¬1 no tiene heridas para curar.
            b = False
            Exit Sub
        End If
        ...
        DamageStr = PonerPuntos(Damage)
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HEALED_TARGET_HP, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(tempChr).name & "¬" & DamageStr)
            Call WriteLocaleMsg(tempChr, MSG_TARGET_RESTORED_HEALTH, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name & "¬" & DamageStr)
        Else
            Call WriteLocaleMsg(UserIndex, MSG_SELF_RESTORED_HEALTH, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, DamageStr)
        End If
        b = True
    ...
    If Hechizos(h).SubeMana = 1 Then
        ...
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1907=Le has restaurado ¬1 puntos de mana a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_RESTAURADO_PUNTOS_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, UserList(UserIndex).name & "¬" & Damage) ' Msg1908=¬1 te ha restaurado ¬2 puntos de mana.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_MANA_1909, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1909=Te has restaurado ¬1 puntos de mana.
        End If
    ...
    ElseIf Hechizos(h).SubeMana = 2 Then
        ...
        Call InfoHechizo(UserIndex)
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1910=Le has quitado ¬1 puntos de mana a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_QUITADO_PUNTOS_MANA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name & "¬" & Damage) ' Msg1911=¬1 te ha quitado ¬2 puntos de mana.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_MANA_1912, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1912=Te has quitado ¬1 puntos de mana.
        End If
        UserList(tempChr).Stats.MinMAN = UserList(tempChr).Stats.MinMAN - Damage
    ...
    If Hechizos(h).SubeSta = 1 Then
        ...
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VITALIDAD, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1913=Le has restaurado ¬1 puntos de vitalidad a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_RESTAURADO_PUNTOS_VITALIDAD, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, UserList(UserIndex).name & "¬" & Damage) ' Msg1914=¬1 te ha restaurado ¬2 puntos de vitalidad.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VITALIDAD_1915, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1915=Te has restaurado ¬1 puntos de vitalidad.
        End If
    ...
    ElseIf Hechizos(h).SubeSta = 2 Then
        ...
        Call InfoHechizo(UserIndex)
        If UserIndex <> tempChr Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_QUITADO_PUNTOS_VITALIDAD, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(tempChr).name) ' Msg1916=Le has quitado ¬1 puntos de vitalidad a ¬2.
            Call WriteLocaleMsg(tempChr, MSG_QUITADO_PUNTOS_VITALIDAD, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name & "¬" & Damage) ' Msg1917=¬1 te ha quitado ¬2 puntos de vitalidad.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VITALIDAD_1915, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1915=Te has restaurado ¬1 puntos de vitalidad.
        End If
        UserList(tempChr).Stats.MinSta = UserList(tempChr).Stats.MinSta - Damage
...
Sub HechizoCombinados(ByVal UserIndex As Integer, ByRef b As Boolean, ByRef IsAlive As Boolean)
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.eDoHeal) Then
        ...
        If UserIndex <> targetUserIndex Then
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VIDA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(targetUserIndex).name) ' Msg1918=Le has restaurado ¬1 puntos de vida a ¬2.
            Call WriteLocaleMsg(targetUserIndex, MSG_RESTAURADO_PUNTOS_VIDA, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, UserList(UserIndex).name & "¬" & Damage) ' Msg1919=¬1 te ha restaurado ¬2 puntos de vida.
        Else
            Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VIDA_1920, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1920=Te has restaurado ¬1 puntos de vida.
        End If
        b = True
            ...
            Select Case Status(UserIndex)
                ...
                Case 2, 4 'Caos
                    If Status(tU) <> e_Facciones.Caos And Status(tU) <> e_Facciones.Criminal And Status(tU) <> e_Facciones.concilio Then
                        ...
                        Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_AYUDAR_CIUDADANOS_668, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                        b = False
                        Exit Sub
                    End If
            End Select
    ...
    If Hechizos(h).desencantar = 1 Then
        ...
        Call WriteLocaleMsg(UserIndex, MSG_SIDO_DESENCANTADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT)
        UserList(UserIndex).flags.Envenenado = 0
        UserList(UserIndex).flags.Incinerado = 0
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.Paralize) Then
        ...
        If UserList(tU).Counters.TiempoDeInmunidadParalisisNoMagicas > 0 Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDE_VOLVER_SER_PARALIZADO_TAN_RAPIDO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(tU).name) ' Msg1872=¬1 no puede volver a ser paralizado tan rápido.
            Exit Sub
        End If
    ...
    If IsSet(Hechizos(h).Effects, e_SpellEffects.Immobilize) Then
        ...
        End If
        If UserList(tU).Counters.TiempoDeInmunidadParalisisNoMagicas > 0 Then
            Call WriteLocaleMsg(UserIndex, MSG_NO_PUEDE_VOLVER_SER_INMOVILIZADO_TAN_RAPIDO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja, UserList(tU).name) ' Msg1873=¬1 no puede volver a ser inmovilizado tan rápido.
            Exit Sub
        End If
        If Not UserMod.CanMove(UserList(tU).flags, UserList(tU).Counters) Then
            ' Msg661=No podes inmovilizar un objetivo que no puede moverse.
    ...
    With UserList(UserIndex)
        If Dire = 1 Then 'Mover arriba
            If CualHechizo = 1 Then
                ...
                Call WriteLocaleMsg(UserIndex, MSG_NO_PODES_MOVER_HECHIZO_ESA_DIRECCION, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
                Exit Sub
            Else
...
Private Sub AreaHechizo(UserIndex As Integer, NpcIndex As Integer, x As Byte, y As Byte, Npc As Boolean)
    ...
    If Npc Then
        If IsSet(Hechizos(h2).Effects, e_SpellEffects.eDoDamage) Then
            ...
            If UserList(UserIndex).ChatCombate = 1 Then
                Call WriteLocaleMsg(UserIndex, MSG_HAS_CAUSADO_PUNTOS_DANO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & NpcList(NpcIndex).name) ' Msg1921=Le has causado ¬1 puntos de daño a ¬2.
            End If
        End If
        Exit Sub
    Else
        ...
        If IsSet(Hechizos(h2).Effects, e_SpellEffects.eDoHeal) Then
            ...
            Call UserMod.DoDamageOrHeal(NpcIndex, UserIndex, eUser, Damage, e_DamageSourceType.e_magic, h2)
            If UserIndex <> NpcIndex Then
                Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VIDA_1922, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage & "¬" & UserList(NpcIndex).name) ' Msg1922=Le has restaurado ¬1 puntos de vida a ¬2.
                Call WriteLocaleMsg(NpcIndex, MSG_RESTAURADO_PUNTOS_VIDA_1923, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, UserList(UserIndex).name & "¬" & Damage) ' Msg1923=¬1 te ha restaurado ¬2 puntos de vida.
            Else
                Call WriteLocaleMsg(UserIndex, MSG_HAS_RESTAURADO_PUNTOS_VIDA_1920, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_PROMEDIO_MAYOR, Damage) ' Msg1920=Te has restaurado ¬1 puntos de vida.
            End If
        End If
    ...
    If Hechizos(h2).Envenena > 0 Then
        ...
        Call WriteLocaleMsg(NpcIndex, MSG_ENVENENADO, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_FIGHT, UserList(UserIndex).name) ' Msg1924=¬1 te ha envenenado.
    End If
...
Public Sub UseSpellSlot(ByVal UserIndex As Integer, ByVal spellSlot As Integer)
    ...
    With UserList(UserIndex)
        ...
        If UserMod.IsStun(.flags, .Counters) Then
            Call WriteLocaleMsg(UserIndex, MSG_CANNOT_CAST_SPELL_STUNNED, e_TextChannel.TEXTCHANNEL_COMBAT, e_FontTypeNames.FONTTYPE_New_Naranja)
            Exit Sub
        End If
