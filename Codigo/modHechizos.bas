...
ElseIf Hechizos(hIndex).SubeHP = 2 Then
   ...
   ' End If
    ...
    Call WriteEfectOverHead(UserIndex, daño, CStr(UserList(UserIndex).Char.CharIndex)) 'LADDER 21.11.08
...
ElseIf Hechizos(h).SubeHP = 2 Then
   ...
   ' If (UserList(tempChr).Invent.AnilloEqpObjIndex > 0) Then
    ...
    Call WriteEfectOverHead(tempChr, daño, UserList(UserIndex).Char.CharIndex) 'LADDER 21.11.08
    'Muere
...
Else
                ...
                If Hechizos(h2).SubeHP = 1 Then
                    ...
                    UserList(NpcIndex).Stats.MinHp = UserList(NpcIndex).Stats.MinHp + daño
                    If UserList(NpcIndex).Stats.MinHp > UserList(NpcIndex).Stats.MaxHp Then _
                        UserList(NpcIndex).Stats.MinHp = UserList(NpcIndex).Stats.MaxHp
                    End If
