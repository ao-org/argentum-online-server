...
126     If (Status(UserIndex) = 0 And Status(InvitadoIndex) = 1) Or (Status(UserIndex) = 1 And Status(InvitadoIndex) = 0) Or (Status(UserIndex) = 1 And Status(InvitadoIndex) = 2) Or (Status(UserIndex) = 2 And Status(InvitadoIndex) = 1) Or (Status(UserIndex) = 3 And Status(InvitadoIndex) = 0) Or (Status(UserIndex) = 0 And Status(InvitadoIndex) = 3) Or (Status(UserIndex) = 3 And Status(InvitadoIndex) = 2) Or (Status(UserIndex) = 2 And Status(InvitadoIndex) = 3) Then
