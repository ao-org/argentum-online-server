...
130     If Abs(CInt(Invitado.Stats.ELV) - CInt(Remitente.Stats.ELV)) > 4 Then
132         Call WriteConsoleMsg(UserIndex, "No podes crear un grupo con personajes con diferencia de más de 4 niveles.", e_FontTypeNames.FONTTYPE_New_GRUPO)
            Exit Sub
