...
Public Sub SetupLobby(ByRef instance As t_Lobby, _
...
Public Sub SetSummonCoordinates(ByRef instance As t_Lobby, _
...
Public Function CanPlayerJoin(ByRef instance As t_Lobby, _
                              ByVal UserIndex As Integer) As t_response
...
Public Function AddPlayer(ByRef instance As t_Lobby, _
                          ByVal UserIndex As Integer, _
                          Optional team As Integer = 0) As t_response
...
Public Function AddPlayerOrGroup(ByRef instance As t_Lobby, _
                                 ByVal UserIndex As Integer, _
                                 ByVal Password As String) As t_response
...
Public Function GiveGoldToPlayer(ByRef instance As t_Lobby, _
                                 ByVal UserSlotIndex As Integer, _
...
Public Function OpenLobby(ByRef instance As t_Lobby, _
            ...
            Else
                ...
                For i = 0 To instance.RegisteredPlayers - 1
                    ...
                    If IsValidUserRef(instance.Players(i).user) Then
                        ...
                        Call SendData(SendTarget.ToIndex, instance.Players(i).user.ArrayIndex, PrepareMessageConsoleMsg("Esperando jugadores, La partida iniciara en " & GetTimeString(Minutes, Seconds) & " o cuando se llene la sala", e_FontTypeNames.FONTTYPE_GUILD))
                        Call SendData(SendTarget.ToIndex, instance.Players(i).user.ArrayIndex, PrepareMessageConsoleMsg("En este momento hay " & instance.RegisteredPlayers & " / " & instance.MaxPlayers & " y se requiere un minimo de " & instance.MinPlayers & " para que pueda iniciar", e_FontTypeNames.FONTTYPE_GUILD))
...
Public Sub RegisterDisconnectedUserOnLobby(ByRef instance As t_Lobby, _
                                           ByVal DisconnectedUserIndex As Integer)
...
Public Sub RegisterReconnectedUserOnLobby(ByRef instance As t_Lobby, _
...
Public Function SetTeamSize(ByRef instance As t_Lobby, _
                            ByVal TeamSize As Integer, _
                            ByVal TeamType As e_TeamTypes) As t_response
...
Public Function SetTeamCount(ByRef instance As t_Lobby, _
                             ByVal TeamCount As Integer, _
                             ByVal TeamType As e_TeamTypes) As t_response
...
Public Function HandleRemoteLobbyCommand(ByVal Command, _
                                         ByVal Params As String, _
                                         ByVal UserIndex As Integer, _
                                         ByVal LobbyIndex As Integer) As Boolean
...
Public Function KickPlayer(ByRef instance As t_Lobby, _
                           ByVal Index As Integer) As t_response
...
Public Function ValidateLobbySettings(ByVal UserIndex As Integer, _
                                      ByRef LobbySettings As t_NewScenearioSettings)
...
Public Sub CreatePublicEvent(ByVal UserIndex As Integer, _
                             ByRef LobbySettings As t_NewScenearioSettings)
