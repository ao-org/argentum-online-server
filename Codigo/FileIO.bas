...
Public Sub CargarHechizos()
    ...
    For Hechizo = 1 To NumeroHechizos
        ...
        If val(Leer.GetValue("Hechizo" & Hechizo, "RequireArmor")) > 0 Then
...
Public Sub LoadEffectOverTime()
    ...
    For i = 1 To EffectCount
        ...
        EffectOverTime(i).OnRemoveFx = val(Leer.GetValue("EOT" & i, "OnRemoveFx"))
        EffectOverTime(i).OnRemoveWav = val(Leer.GetValue("EOT" & i, "OnRemoveWav"))
