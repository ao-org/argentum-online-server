...
Private Function UpdateEffect(ByVal Index As Integer, _
                              ByVal ElapsedTime As Long) As Boolean
...
Public Sub CreateUnequip(ByVal TargetIndex As Integer, _
                         ByVal TargetType As e_ReferenceType, _
                         ByVal ItemSlotType As Long)
...
Public Sub AddEffect(ByRef EffectList As t_EffectOverTimeList, _
...
Public Sub RemoveEffect(ByRef EffectList As t_EffectOverTimeList, _
                        ByRef Effect As IBaseEffectOverTime, _
                        Optional ByVal CallRemove As Boolean = True)
...
Public Function FindEffectOfTypeOnTarget(ByRef EffectList As t_EffectOverTimeList, _
                                         ByVal TargetType As e_EffectType) As IBaseEffectOverTime
...
Public Function FindEffectOnTarget(ByVal CasterIndex As Integer, _
                                   ByRef EffectList As t_EffectOverTimeList, _
                                   ByVal EffectId As Integer) As IBaseEffectOverTime
...
Public Sub ClearEffectList(ByRef EffectList As t_EffectOverTimeList, _
                           Optional ByVal Filter As e_EffectType = e_EffectType.eAny, _
                           Optional ByVal ClearForDeath As Boolean = False)
...
Public Sub RemoveEffectAtPos(ByRef EffectList As t_EffectOverTimeList, _
...
Public Sub TargetUseMagic(ByRef EffectList As t_EffectOverTimeList, _
                          ByVal TargetUserId As Integer, _
                          ByVal SourceType As e_ReferenceType, _
                          ByVal MagicId As Integer)
...
Public Sub TartgetWillAtack(ByRef EffectList As t_EffectOverTimeList, _
                            ByVal TargetUserId As Integer, _
                            ByVal SourceType As e_ReferenceType, _
                            ByVal AttackType As e_DamageSourceType)
...
Public Sub TartgetDidHit(ByRef EffectList As t_EffectOverTimeList, _
                         ByVal TargetUserId As Integer, _
                         ByVal SourceType As e_ReferenceType, _
                         ByVal AttackType As e_DamageSourceType)
...
Public Sub TargetFailedAttack(ByRef EffectList As t_EffectOverTimeList, _
                              ByVal TargetUserId As Integer, _
                              ByVal SourceType As e_ReferenceType, _
                              ByVal AttackType As e_DamageSourceType)
...
Public Sub TargetWasDamaged(ByRef EffectList As t_EffectOverTimeList, _
                            ByVal SourceUserId As Integer, _
                            ByVal SourceType As e_ReferenceType, _
                            ByVal AttackType As e_DamageSourceType)
...
Public Sub TargetWillAttackPosition(ByRef EffectList As t_EffectOverTimeList, _
                                    ByRef Position As t_WorldPos)
...
Public Function ApplyEotModifier(ByRef TargetRef As t_AnyReference, _
                                 ByRef EffectStats As t_EffectOverTime, _
                                 Optional ByVal Modifier As Single = 0)
...
Public Function RemoveEotModifier(ByRef TargetRef As t_AnyReference, _
                                  ByRef EffectStats As t_EffectOverTime, _
                                  Optional ByVal Modifier As Single = 0)
