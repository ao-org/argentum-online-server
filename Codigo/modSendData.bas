...
Public Sub SendData(ByVal sndRoute As SendTarget, _
                    ...
                    Optional ByVal ValidateInvi As Boolean = False)
...
348                     If UserList(LoopC).Faccion.Status = e_Facciones.Armada Or (UserList(LoopC).flags.Privilegios And (e_PlayerType.Admin Or e_PlayerType.Dios Or e_PlayerType.SemiDios Or e_PlayerType.Consejero)) <> 0 Or UserList(LoopC).Faccion.Status = e_Facciones.consejo Then
...
360                     If UserList(LoopC).Faccion.Status = e_Facciones.Caos Or (UserList(LoopC).flags.Privilegios And (e_PlayerType.Admin Or e_PlayerType.Dios Or e_PlayerType.SemiDios Or e_PlayerType.Consejero)) <> 0 Or UserList(LoopC).Faccion.Status = e_Facciones.concilio Then
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToUserAliveArea(ByVal UserIndex As Integer, _
                                    ByVal Buffer As Network.Writer, _
                                    Optional ByVal ValidateInvi As Boolean = False)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToUserArea(ByVal UserIndex As Integer, _
                               ByVal Buffer As Network.Writer, _
                               Optional ByVal ValidateInvi As Boolean)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToUserAreaButFollowerAndIndex(ByVal UserIndex As Integer, _
                                                  ByVal Buffer As Network.Writer)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToPCDeadArea(ByVal UserIndex As Integer, _
                                 ByVal Buffer As Network.Writer)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToPCDeadAreaButIndex(ByVal UserIndex As Integer, _
                                         ByVal Buffer As Network.Writer)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToSuperioresArea(ByVal UserIndex As Integer, _
                                     ByVal Buffer As Network.Writer)
        #Else
...
Public Function CheckGuildSend(ByRef SourceUser As t_User, _
                               ByRef TargetUser As t_User) As Boolean
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToUserAliveAreaButindex(ByVal UserIndex As Integer, _
                                            ByRef Buffer As Network.Writer, _
                                            Optional ByVal ValidateInvi As Boolean = False)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToAdminAreaButIndex(ByVal UserIndex As Integer, _
                                        ByVal Buffer As Network.Writer)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToUserAreaButGMs(ByVal UserIndex As Integer, _
                                     ByVal Buffer As Network.Writer)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToMapButIndex(ByVal UserIndex As Integer, _
                                  ByVal Buffer As Network.Writer)
        #Else
...
#If DIRECT_PLAY = 0 Then
    Private Sub SendToGroupButIndex(ByVal UserIndex As Integer, _
                                    ByVal Buffer As Network.Writer)
        #Else
