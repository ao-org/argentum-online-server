...
Public Function FactionCanAttackFaction(ByVal AttackerFaction As e_Facciones, _
                                        ByVal TargetFaction As e_Facciones)
...
Public Function FactionCanHelpFaction(ByVal SourceFaction As e_Facciones, _
                                      ByVal TargetFaction As e_Facciones) As e_InteractionResult
...
Private Function CheckMapRestrictions(ByVal UserIndex As Integer, _
                                      ByVal Map As Integer) As Boolean
...
Public Function GetTransportNextIndex(ByVal Map As Integer, _
                                      ByVal PosX As Byte, _
                                      ByVal PosY As Byte) As Integer
...
Public Function GetExitTransport(ByVal Map As Integer, _
                                 ByVal ExcludeIndex As Integer) As Integer
...
Function ClosestLegalPosNPC(ByVal NpcIndex As Integer, _
                            ...
                            Optional ByVal IgnoreUsers As Boolean, _
                            Optional ByVal IgnoreDeadUsers As Boolean) As t_WorldPos
...
Public Sub resetPj(ByVal UserIndex As Integer, _
                   Optional ByVal borrarHechizos As Boolean = False)
...
Public Function TestRequiredEquipedItem(ByRef inventory As t_Inventario, _
                                        ByVal RequiredItemsFlag As Long, _
                                        ByVal RequiredWeaponMask As Integer) As e_SpellRequirementMask

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eArmor) And inventory.ArmourEqpObjIndex = 0 Then
        TestRequiredEquipedItem = e_SpellRequirementMask.eArmor
        Exit Function

    End If

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eHelm) And inventory.CascoEqpObjIndex = 0 Then
        TestRequiredEquipedItem = e_SpellRequirementMask.eHelm
        Exit Function

    End If

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eMagicItem) And inventory.MagicoObjIndex = 0 Then
        TestRequiredEquipedItem = e_SpellRequirementMask.eMagicItem
        Exit Function

    End If

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eProjectile) And inventory.MunicionEqpObjIndex = 0 Then
        TestRequiredEquipedItem = e_SpellRequirementMask.eProjectile
        Exit Function

    End If

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eShield) And inventory.EscudoEqpObjIndex = 0 Then
        TestRequiredEquipedItem = e_SpellRequirementMask.eShield
        Exit Function

    End If

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eShip) And inventory.BarcoObjIndex = 0 Then
        TestRequiredEquipedItem = e_SpellRequirementMask.eShip
        Exit Function

    End If

    If IsSet(RequiredItemsFlag, e_SpellRequirementMask.eTool) And inventory.HerramientaEqpObjIndex = 0 Then
...
Public Sub SendrequiredItemMessage(ByVal UserIndex As Integer, _
                                   ByVal itemMask As e_SpellRequirementMask, _
...
Public Sub SendHelpInteractionMessage(ByVal UserIndex As Integer, _
                                      ByVal CanHelpResult As e_InteractionResult)
...
Public Sub SendAttackInteractionMessage(ByVal UserIndex As Integer, _
                                        ByVal CanAttackResult As e_AttackInteractionResult)
...
Public Function PreferedTileForDirection(ByRef Direction As t_Vector, _
                                         ByRef currentPosition As t_WorldPos) As t_WorldPos
