...
Public Declare Function AOT_CheckIdErrors _
               Lib "AoServerTools.dll" (ByVal TelemetryId As Long, _
                                        ByRef OutBuffer As Byte, _
                                        ByVal BuffLength As Long) As Long

Public Declare Function AOT_GetTelemetryCode _
               Lib "AoServerTools.dll" (ByVal TelemetryId As Long, _
                                        ByVal name As String, _
                                        ByRef OutBuffer As Byte, _
                                        ByVal BuffLength As Long) As Long

Public Declare Function AOT_GetTelemetryResult _
               Lib "AoServerTools.dll" (ByRef data As Byte, _
                                        ByVal DataSize As Long, _
                                        ByVal TelemetryId As Long, _
                                        ByRef OutBuffer As Byte, _
                                        ByVal BuffLength As Long) As Long

Public Declare Function AOT_UpdateUserKey _
               Lib "AoServerTools.dll" (ByVal Id As Long, _
                                        ByVal level As Long, _
                                        ByVal Exp As Long, _
                                        ByVal gold As Long, _
                                        ByVal BankGold As Long, _
                                        ByVal PrevKey As String, _
                                        ByVal PrevKeySize As Long, _
                                        ByRef OutBuffer As Byte, _
                                        ByVal OutBufferSize As Byte) As Long

Public Declare Function AOT_SetUserKey _
               Lib "AoServerTools.dll" (ByVal Id As Long, _
                                        ByVal level As Long, _
                                        ByVal Exp As Long, _
                                        ByVal gold As Long, _
