...
120                             Call WriteConsoleMsg(Index, PrepareMessageLocaleMsg(1931, PonerPuntos(OroDar), e_FontTypeNames.FONTTYPE_New_GRUPO)) ' Msg1931=¡El grupo ha ganado ¬1 monedas de oro!
                            End If
