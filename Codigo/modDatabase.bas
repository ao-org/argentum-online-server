...
Public Function Query(ByVal Text As String, _
                      ParamArray Arguments() As Variant) As ADODB.Recordset
...
Public Function Invoke(ByVal Procedure As String, _
                       ParamArray Arguments() As Variant) As ADODB.Recordset
...
Private Function CreateParameter(ByVal value As Variant, _
                                 ByVal Direction As ADODB.ParameterDirectionEnum) As ADODB.Parameter
...
Public Function GetDBValue(Tabla As String, _
                           ColumnaGet As String, _
                           ColumnaTest As String, _
                           ValueTest As Variant) As Variant
...
Public Sub SetDBValue(Tabla As String, _
                      ColumnaSet As String, _
                      ByVal ValueSet As Variant, _
                      ColumnaTest As String, _
                      ByVal ValueTest As Variant)
...
Public Sub SaveUserSkillDatabase(username As String, _
...
Public Sub SaveBanCuentaDatabase(ByVal AccountID As Long, _
                                 Reason As String, _
                                 BannedBy As String)
...
Public Sub CambiarPenaDatabase(username As String, _
...
Public Sub SaveUserGuildAspirantDatabase(ByVal UserId As Long, _
...
Public Function EnterAccountDatabase(ByVal UserIndex As Integer, _
                                     ByVal CuentaEmail As String) As Boolean
...
Public Function PersonajePerteneceID(ByVal username As String, _
                                     ByVal AccountID As Long) As Boolean
...
Public Function SetPositionDatabase(username As String, _
...
Public Function AddOroBancoDatabase(username As String, _
                                    ByVal OroGanado As Long) As Boolean
