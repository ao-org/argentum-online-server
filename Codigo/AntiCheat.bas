...
Private Declare Function InitializeAC _
                Lib "AOACServer.dll" (ByRef Callbacks As t_AntiCheatCallbacks) As Long
Private Declare Sub UnloadAC Lib "AOACServer.dll" ()
Private Declare Sub Update Lib "AOACServer.dll" ()
Private Declare Sub AddPendingRegister _
                Lib "AOACServer.dll" (ByRef UserReference As t_UserReference)
Private Declare Function QueryAndRemoveOldPendingRegistey _
                Lib "AOACServer.dll" (ByRef UserReference As t_UserReference, _
                                      ByVal ElapsedThreshold As Long) As Long
Private Declare Sub UnRegisterClient Lib "AOACServer.dll" (ByVal UserIndex As Integer)
Private Declare Sub HandleRemoteMessage _
                Lib "AOACServer.dll" (ByRef UserReference As t_UserReference, _
...
Public Sub SendToClientCB(ByRef TargetUser As t_UserReference, _
...
Public Sub RegisterRemoteUserIdCb(ByRef UserRef As t_UserReference, _
                                  ByRef Id As SINGLESTRINGPARAM)
...
Public Sub ClientActionRequired(ByRef UserRef As t_UserReference, _
                                ByVal Action As Long, _
                                ByVal ReasonCode As Long, _
                                ByRef ReasonString As SINGLESTRINGPARAM)
