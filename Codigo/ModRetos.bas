...
Public Sub CrearReto(ByVal UserIndex As Integer, _
                     JugadoresStr As String, _
...
Public Sub AbandonarReto(ByVal UserIndex As Integer, _
                         Optional ByVal Desconexion As Boolean)
...
Private Function IndiceJugadorEnSolicitud(ByVal UserIndex As Integer, _
                                          ByVal Oferente As Integer) As Integer
...
Private Sub MensajeATodosSolicitud(ByVal Oferente As Integer, _
                                   mensaje As String, _
                                   ByVal Fuente As e_FontTypeNames)
