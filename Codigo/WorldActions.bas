...
Public Function IsNpcWorldInteractable(ByVal NpcIndex As Integer) As Boolean
    ...
    With NpcList(NpcIndex)
        ...
        Select Case .npcType
            Case e_NPCType.Banquero, e_NPCType.Pirata, e_NPCType.Revividor, e_NPCType.ResucitadorNewbie, e_NPCType.Subastador, e_NPCType.Quest, e_NPCType.Enlistador, e_NPCType.Gobernador, e_NPCType.EntregaPesca, e_NPCType.AO20Shop, e_NPCType.AO20ShopPjs, e_NPCType.EventMaster, e_NPCType.Transportista
                IsNpcWorldInteractable = True
        End Select
    End With
End Function
...
Private Sub HandleNpcInteractionByType(ByVal UserIndex As Integer, ByVal NpcIndex As Integer)
            ...
            ElseIf NpcList(NpcIndex).npcType = e_NPCType.Transportista Then
                If Not EnsureUserAliveForNpcInteraction(UserIndex, e_FontTypeNames.FONTTYPE_INFO) Then Exit Sub
                If Not EnsureUserNotTrading(UserIndex) Then Exit Sub
