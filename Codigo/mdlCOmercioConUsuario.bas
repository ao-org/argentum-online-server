...
Public Function IniciarComercioConUsuario(ByVal Origen As Integer, _
                                          ByVal Destino As Integer) As Boolean
...
Public Sub EnviarObjetoTransaccion(ByVal AQuien As Integer, _
                                   ByVal UserIndex As Integer, _
                                   ByRef ObjAEnviar As t_Obj)
...
Public Sub FinComerciarUsu(ByVal UserIndex As Integer, _
                           Optional ByVal Invalido As Boolean = False)
