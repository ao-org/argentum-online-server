...
Private Sub CerrarYForzarActualizar_Click()
    ...
    Exit Sub
Command4_Click_Err:
    Call TraceError(Err.Number, Err.Description, "frmMain.CerrarYForzarActualizar", Erl)
End Sub
...
Private Sub T_UsersOnline_Timer()
    ...
    Exit Sub
T_UsersOnline_Err:
    Call TraceError(Err.Number, Err.Description, "General.T_UsersOnline", Erl)
End Sub
...
Private Sub SubastaTimer_Timer()
    ...
    If Subasta.TiempoRestanteSubasta = 240 And Subasta.HuboOferta = False And Subasta.MejorOferta = 0 Then
    ...
    If Subasta.TiempoRestanteSubasta = 180 And Subasta.HuboOferta = False And Subasta.MejorOferta = 0 Then
