...
Public Function IntervaloPermiteTirar(ByVal UserIndex As Integer, _
                                      Optional ByVal Actualizar As Boolean = True) As Boolean
...
' TRABAJO
Public Function IntervaloPermiteTrabajarExtraer(ByVal UserIndex As Integer, _
                                                Optional ByVal Actualizar As Boolean = True) As Boolean
...
Public Function IntervaloPermiteTrabajarConstruir(ByVal UserIndex As Integer, _
                                                  Optional ByVal Actualizar As Boolean = True) As Boolean
