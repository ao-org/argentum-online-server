...
If Map > 0 And Map < NumMaps + 1 And x > 0 And x < 101 And Y > 0 And Y < 101 Then
    If ((MapData(Map, x, Y).Graphic(1) >= 22552 And MapData(Map, x, Y).Graphic(1) <= 22599) Or _
    (MapData(Map, x, Y).Graphic(1) >= 7283 And MapData(Map, x, Y).Graphic(1) <= 7378) Or _
    (MapData(Map, x, Y).Graphic(1) >= 13387 And MapData(Map, x, Y).Graphic(1) <= 13482)) And _
...
If Map > 0 And Map < NumMaps + 1 And x > 0 And x < 101 And Y > 0 And Y < 101 Then
    ...
    (MapData(Map, x, Y).Graphic(1) >= 24223 And MapData(Map, x, Y).Graphic(1) <= 24238) Or _
    (MapData(Map, x, Y).Graphic(1) >= 24303 And MapData(Map, x, Y).Graphic(1) <= 24318) Or _
    (MapData(Map, x, Y).Graphic(1) >= 468 And MapData(Map, x, Y).Graphic(1) <= 483) Or _
    (MapData(Map, x, Y).Graphic(1) >= 44668 And MapData(Map, x, Y).Graphic(1) <= 44939) Or _
    (MapData(Map, x, Y).Graphic(1) >= 24143 And MapData(Map, x, Y).Graphic(1) <= 24158)) And _
       MapData(Map, x, Y).Graphic(2) = 0 Then
            HayAgua = True
    Else
            HayAgua = False
...
Public Function Intemperie(ByVal UserIndex As Integer) As Boolean
    ...
    If MapInfo(UserList(UserIndex).Pos.Map).zone <> "DUNGEON" Then
        If MapData(UserList(UserIndex).Pos.Map, UserList(UserIndex).Pos.x, UserList(UserIndex).Pos.Y).trigger <> 1 And _
           ...
           MapData(UserList(UserIndex).Pos.Map, UserList(UserIndex).Pos.x, UserList(UserIndex).Pos.Y).trigger < 10 And _
...
If UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 10 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= -1 Then
                    Suerte = 5
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 20 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 11 Then
                    Suerte = 7
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 30 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 21 Then
                    Suerte = 9
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 40 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 31 Then
                    Suerte = 11
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 50 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 41 Then
                    Suerte = 13
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 60 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 51 Then
                    Suerte = 15
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 70 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 61 Then
                    Suerte = 17
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 80 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 71 Then
                    Suerte = 19
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) <= 90 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 81 Then
                    Suerte = 21
ElseIf UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) < 100 _
   And UserList(UserIndex).Stats.UserSkills(eSkill.Supervivencia) >= 91 Then
                    Suerte = 23
