...
Sub BlockAndInform(ByVal Map As Integer, _
                   ByVal x As Integer, _
                   ByVal y As Integer, _
...
104             HayAgua = (.Graphic(1) >= 1505 And .Graphic(1) <= 1520) Or (.Graphic(1) >= 124 And .Graphic(1) <= 139) Or (.Graphic(1) >= 24223 And .Graphic(1) <= 24238) Or (.Graphic(1) >= 24303 And .Graphic(1) <= 24318) Or (.Graphic(1) >= 468 And .Graphic(1) <= 483) Or (.Graphic(1) >= 44668 And .Graphic(1) <= 44683) Or (.Graphic(1) >= 24143 And .Graphic(1) <= 24158) Or (.Graphic(1) >= 12628 And .Graphic(1) <= 12643) Or (.Graphic(1) >= 2948 And .Graphic(1) <= 2963)
            Else
106             HayAgua = False
...
100     EsArbol = GrhIndex = 11905 Or GrhIndex = 644 Or GrhIndex = 1880 Or GrhIndex = 11906 Or GrhIndex = 12160 Or GrhIndex = 6597 Or GrhIndex = 2548 Or GrhIndex = 2549 Or GrhIndex = 15110 Or GrhIndex = 15109 Or GrhIndex = 15108 Or GrhIndex = 11904 Or GrhIndex = 7220 Or GrhIndex = 50990 Or GrhIndex = 55626 Or GrhIndex = 55627 Or GrhIndex = 55630 Or GrhIndex = 55632 Or GrhIndex = 55633 Or GrhIndex = 55635 Or GrhIndex = 55638 Or GrhIndex = 12584 Or GrhIndex = 50985 Or GrhIndex = 15510 Or GrhIndex = 14775 Or GrhIndex = 14687 Or GrhIndex = 11903 Or GrhIndex = 735 Or GrhIndex = 15698 Or GrhIndex = 14504 Or GrhIndex = 15697 Or GrhIndex = 6598 Or GrhIndex = 1121 Or GrhIndex = 1878 Or GrhIndex = 9513 Or GrhIndex = 9514 Or GrhIndex = 9515 Or GrhIndex = 9518 Or GrhIndex = 9519 Or GrhIndex = 9520 Or GrhIndex = 9529
        Exit Function
EsArbol_Err:
...
106                     NpcList(UserList(UserIndex).MascotasIndex(i).ArrayIndex).Contadores.TiempoExistencia = NpcList(UserList(UserIndex).MascotasIndex(i).ArrayIndex).Contadores.TiempoExistencia - 1
...
Public Sub PierdeEnergia(ByVal UserIndex As Integer, _
                         ByRef EnviarStats As Boolean, _
                         ByVal Intervalo As Integer)
        On Error GoTo RecStamina_Err
...
Function RandomString(cb As Integer, _
                      Optional ByVal OnlyUpper As Boolean = False) As String
