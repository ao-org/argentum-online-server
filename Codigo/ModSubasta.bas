...
End If
    ...
    If tUser <= 0 Or EstaBattle Then
            ...
            Else
                ...
                If MapData(PosMap, posX, posY).ObjInfo.ObjIndex > 0 Then _
                    Exit Sub
                If MapData(PosMap, posX, posY).TileExit.Map > 0 Then _
                    Exit Sub
                If Subasta.ObjSubastado < 1 Or Subasta.ObjSubastado > NumObjDatas Then _
                    Exit Sub
