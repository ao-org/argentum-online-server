...
104                 Call WriteConsoleMsg(.ComUsu.DestUsu.ArrayIndex, PrepareMessageLocaleMsg(1949, .name, e_FontTypeNames.FONTTYPE_TALK)) ' Msg1949=¬1 ha dejado de comerciar con vos.
...
108                 Call WriteConsoleMsg(otherUser, PrepareMessageLocaleMsg(1950, .name, e_FontTypeNames.FONTTYPE_TALK)) ' Msg1950=¬1 ha rechazado tu oferta.
...
164                 Call WriteConsoleMsg(tUser, PrepareMessageLocaleMsg(1951, .name, e_FontTypeNames.FONTTYPE_TALK)) ' Msg1951=¬1 ha cambiado su oferta.
...
124                     Call WriteConsoleMsg(UserIndex, PrepareMessageLocaleMsg(1952, username, e_FontTypeNames.FONTTYPE_INFO)) ' Msg1952=¬1 expulsado de las fuerzas del caos y prohibida la reenlistada.
126                     Call WriteConsoleMsg(tUser.ArrayIndex, PrepareMessageLocaleMsg(1953, .name, e_FontTypeNames.FONTTYPE_FIGHT)) ' Msg1953=¬1 te ha expulsado en forma definitiva de las fuerzas del caos.
                    End If
                Else
...
124                     Call WriteConsoleMsg(UserIndex, PrepareMessageLocaleMsg(1954, username, e_FontTypeNames.FONTTYPE_INFO)) ' Msg1954=¬1 expulsado de las fuerzas reales y prohibida la reenlistada.
126                     Call WriteConsoleMsg(tUser.ArrayIndex, PrepareMessageLocaleMsg(1955, .name, e_FontTypeNames.FONTTYPE_FIGHT)) ' Msg1955=¬1 te ha expulsado en forma definitiva de las fuerzas reales.
                    End If
...
104             Call WriteConsoleMsg(UserIndex, PrepareMessageLocaleMsg(1957, PublicidadEvento & "¬" & TiempoRestanteEvento, e_FontTypeNames.FONTTYPE_New_Eventos)) ' Msg1957=¬1. Tiempo restante: ¬2 minuto(s).
            Else
