...
122         isNotVisible = (.flags.Oculto Or .flags.invisible)

124         If isNotVisible And .flags.AdminInvisible = 0 Then
126             .flags.Oculto = 0
128             .flags.invisible = 0

130             .Counters.Invisibilidad = 0
132             .Counters.TiempoOculto = 0
                
                'Call WriteConsoleMsg(UserIndex, "Has vuelto a ser visible.", FontTypeNames.FONTTYPE_INFO)
134             Call WriteLocaleMsg(UserIndex, "307", FontTypeNames.FONTTYPE_INFO)
136             Call SendData(SendTarget.ToPCArea, UserIndex, PrepareMessageSetInvisible(.Char.CharIndex, False))
