...
Public Sub InitializePacketList()
    ...
    PacketList(ClientPacketID.AddItemCrafting) = GetAddress(AddressOf HandleAddItemCrafting)
    PacketList(ClientPacketID.RemoveItemCrafting) = GetAddress(AddressOf HandleRemoveItemCrafting)
    PacketList(ClientPacketID.AddCatalyst) = GetAddress(AddressOf HandleAddCatalyst)
    PacketList(ClientPacketID.RemoveCatalyst) = GetAddress(AddressOf HandleRemoveCatalyst)
        ...
        Else
            ...
            If LenB(chat) <> 0 Then
                ...
                If .flags.Muerto = 1 Then
                    ...
                    Call SendData(SendTarget.ToUsuariosMuertos, UserIndex, PrepareMessageChatOverHead(chat, .Char.CharIndex, CHAT_COLOR_DEAD_CHAR, UserList(UserIndex).Name))
...
Private Sub HandleKillNPC(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        If .flags.Privilegios And (PlayerType.user Or PlayerType.Consejero) Then
            Call WriteConsoleMsg(UserIndex, "Solo los Administradores y Dioses pueden usar este comando.", FontTypeNames.FONTTYPE_INFO)
        Exit Sub
        End If
...
Private Sub HandleBanIP(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        Dim NickOrIP As String: NickOrIP = .incomingData.ReadASCIIString()
        Dim Reason As String: Reason = .incomingData.ReadASCIIString()
        ...
        Call BanearIP(UserIndex, NickOrIP, bannedIP)
    ...
    With UserList(UserIndex)
        ...
        If EntrarCuenta(UserIndex, CuentaEmail, CuentaPassword, MacAddress, HDSerial, MD5) Then
            ...
            Select Case AOGuard.AOG_STATUS
                ...
                Case 1
                    Verificar = Not AOGuard.VerificarOrigen(.AccountID, HDSerial, .IP)
...
Private Sub HandleBorrarPJ(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        If GetUserLevelDatabase(UserDelete) >= 25 Then
            Call WriteShowMessageBox(UserIndex, "No puedes eliminar un personaje mayor a nivel 25.")
            Exit Sub
        End If
...
Sub HandleAddItemCrafting(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        InvSlot = .incomingData.ReadByte
        CraftSlot = .incomingData.ReadByte
