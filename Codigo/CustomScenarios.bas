...
Public Sub PlayerKillNpc(ByVal MapNumber As Integer, _
...
Public Sub NPcKillPlayer(ByVal MapNumber As Integer, _
                         ByVal NpcIndex As Integer, _
                         ByVal UserIndex As Integer, _
                         ByVal SourceType As e_DamageSourceType, _
                         ByVal SourceIndex As Integer)
...
Public Sub UserDropItem(ByVal UserIndex As Integer, _
...
Public Function UserCanDropItem(ByVal UserIndex As Integer, _
                                ByVal Slot As Integer, _
                                ByVal Map As Integer, _
                                ByVal TileX As Integer, _
...
Public Sub GetNextWaypointForNpc(ByVal NpcIndex As Integer, _
                                 ByRef PosX As Integer, _
                                 ByRef PosY As Integer)
