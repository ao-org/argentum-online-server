...
206         .Contadores.IntervaloRespawn = RandomNumber((val(Leer.GetValue("NPC" & NpcNumber, "IntervaloRespawn")) * 0.7), val(Leer.GetValue("NPC" & NpcNumber, "IntervaloRespawn")))
            'Debug.Print .Contadores.IntervaloRespawn
