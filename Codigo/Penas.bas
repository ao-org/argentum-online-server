...
Private Function GlobalChecks(ByVal BannerIndex As Integer, _
                              ByRef username As String) As Integer
...
Public Sub BanPJ(ByVal BannerIndex As Integer, _
                 ByVal username As String, _
                 ByRef Razon As String)
...
Public Function DesbanearCuenta(ByVal BannerIndex As Integer, _
                                ByVal UserNameOEmail As String) As Boolean
