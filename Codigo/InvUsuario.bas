...
Public Function IsItemInCooldown(ByVal UserIndex, ByRef obj As t_UserOBJ) As Boolean
    Dim elapsedTime As Long
    ElapsedTime = GetTickCount() - UserList(UserIndex).CdTimes(ObjData(obj.objIndex).cdType)
