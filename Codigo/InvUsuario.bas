...
132             Call WriteConsoleMsg(UserIndex, PrepareMessageLocaleMsg(1981, obj.MinELV, e_FontTypeNames.FONTTYPE_INFO)) ' Msg1981=Necesitas ser nivel ¬1 para usar este item.
                Exit Sub
