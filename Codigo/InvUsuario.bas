                        ...
                        If TargObj.Cerrada = 1 Then
                              ...
                              If TargObj.Llave > 0 Then
                                 If TargObj.clave = obj.clave Then
                                    ...
                                    If obj.clave = 1300 Then Call QuitarObjetos(3554, 1000, UserIndex)
                                    If obj.clave = 1301 Then Call QuitarObjetos(3558, 1000, UserIndex)
                                    If obj.clave = 1302 Then Call QuitarObjetos(3562, 1000, UserIndex)
                                    If obj.clave = 1303 Then Call QuitarObjetos(3566, 1000, UserIndex)
                                    If obj.clave = 1304 Then Call QuitarObjetos(3570, 1000, UserIndex)
                                    If obj.clave = 1305 Then Call QuitarObjetos(3574, 1000, UserIndex)
                                    Exit Sub
                                 Else
