...
ErrHandler:
104     Call TraceError(Err.Number, Err.Description, "ModLimpieza.InicializarLimpieza")
106
...
hErr:
122     Call TraceError(Err.Number, Err.Description, "ModLimpieza.AgregarItemLimpiza")
124
...
hErr:
116     Call TraceError(Err.Number, Err.Description, "ModLimpieza.LimpiarItemsViejos")
118
...
hErr:
110     Call TraceError(Err.Number, Err.Description, "ModLimpieza.LimpiezaForzada")
112
