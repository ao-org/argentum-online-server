...
Public Sub SetTranslationState(ByRef Reference As t_AnyReference, _
                               ByVal NewState As Boolean)
...
Public Function UserCanAttack(ByVal UserIndex As Integer, _
                              ByVal UserVersionId, _
                              ByRef Reference As t_AnyReference) As e_AttackInteractionResult
...
Public Function NpcCanAttack(ByVal NpcIndex As Integer, _
                             ByRef Reference As t_AnyReference) As e_AttackInteractionResult
...
Public Sub UpdateIncreaseModifier(ByRef Reference As t_AnyReference, _
                                  ByVal Modifier As e_ModifierTypes, _
...
Public Function AddShieldToReference(ByRef SourceRef As t_AnyReference, _
                                     ByVal ShieldSize As Long)
