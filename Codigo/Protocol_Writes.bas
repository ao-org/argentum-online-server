...
Public Sub WriteIntervals(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        Call Writer.WriteInt32(.Intervals.Hit)
        Call Writer.WriteInt32(.Intervals.Bow)
        Call Writer.WriteInt32(.Intervals.Magic)
        Call Writer.WriteInt32(.Intervals.ExtractWork)
        Call Writer.WriteInt32(.Intervals.BuildWork)
        Call Writer.WriteInt32(.Intervals.Walk)
        Call Writer.WriteInt32(.Intervals.DropItem)
        Call Writer.WriteInt32(.Intervals.UseItemKey)
        Call Writer.WriteInt32(.Intervals.UseItemClick)
        Call Writer.WriteInt32(.Intervals.HitMagic)
        Call Writer.WriteInt32(.Intervals.MagicHit)
        Call Writer.WriteInt32(.Intervals.HitUseItem)
        Call Writer.WriteInt32(.Intervals.Hide)
    End With
    Call modSendData.SendData(ToIndex, UserIndex)
    Exit Sub
WriteIntervals_Err:
