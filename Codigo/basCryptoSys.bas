...
#Else
    ...
    Public Declare Function API_LicenceType _
                   Lib "diCryptoSys.dll" (ByVal nReserved As Long) As Long

    Public Declare Function API_CompileTime _
                   Lib "diCryptoSys.dll" (ByVal strCompiledOn As String, _
                                          ByVal nMaxChars As Long) As Long

    Public Declare Function API_ModuleName _
                   Lib "diCryptoSys.dll" (ByVal strModuleName As String, _
                                          ByVal nMaxChars As Long, _
                                          ByVal nReserved As Long) As Long

    Public Declare Function API_ErrorCode _
                   Lib "diCryptoSys.dll" () As Long    ' Added [v4.2] (only for certain fns)

    Public Declare Function API_ErrorLookup _
                   Lib "diCryptoSys.dll" (ByVal strErrMsg As String, _
                                          ByVal nMaxChars As Long, _
                                          ByVal nErrCode As Long) As Long

    Public Declare Function API_PowerUpTests _
                   Lib "diCryptoSys.dll" (ByVal nReserved As Long) As Long

    ' New in [v6.21]
    Public Declare Function API_Platform _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nOutChars As Long) As Long

    Public Declare Function API_ModuleInfo _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
    ...
    Public Declare Function AES128_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
    ...
    Public Declare Function AES128_Init _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByRef lpInitV As Byte) As Long

    Public Declare Function AES128_InitHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByVal strHexIV As String) As Long

    Public Declare Function AES128_Update _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function AES128_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strHexData As String) As Long

    Public Declare Function AES128_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function AES192_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long) As Long
    ...
    Public Declare Function AES192_Init _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByRef lpInitV As Byte) As Long

    Public Declare Function AES192_InitHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByVal strHexIV As String) As Long

    Public Declare Function AES192_Update _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function AES192_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strHexData As String) As Long

    Public Declare Function AES192_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function AES256_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long) As Long
    ...
    Public Declare Function AES256_Init _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByRef lpInitV As Byte) As Long

    Public Declare Function AES256_InitHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByVal strHexIV As String) As Long

    Public Declare Function AES256_Update _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function AES256_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strHexData As String) As Long

    Public Declare Function AES256_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function BLF_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long) As Long
    ...
    Public Declare Function BLF_InitHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByVal strHexIV As String) As Long
    ...
    Public Declare Function BLF_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strHexData As String) As Long

    Public Declare Function BLF_Update _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function BLF_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function DES_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long) As Long
    ...
    Public Declare Function DES_Init _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByRef lpInitV As Byte) As Long

    Public Declare Function DES_InitHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByVal strHexIV As String) As Long

    Public Declare Function DES_Update _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function DES_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strHexData As String) As Long

    Public Declare Function DES_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    Public Declare Function DES_InitError Lib "diCryptoSys.dll" () As Long

    ' Checks for weak or invalid-length DES or TDEA keys
    Public Declare Function DES_CheckKey _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal nKeyBytes As Long) As Long

    Public Declare Function DES_CheckKeyHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String) As Long
    ...
    Public Declare Function TDEA_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long) As Long
    ...
    Public Declare Function TDEA_Init _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByRef lpInitV As Byte) As Long

    Public Declare Function TDEA_InitHex _
                   Lib "diCryptoSys.dll" (ByVal strHexKey As String, _
                                          ByVal fEncrypt As Long, _
                                          ByVal strMode As String, _
                                          ByVal strHexIV As String) As Long

    Public Declare Function TDEA_Update _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function TDEA_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strHexData As String) As Long

    Public Declare Function TDEA_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function CIPHER_UpdateHex _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strOutput As String, _
                                          ByVal nOutChars As Long, _
                                          ByVal strDataHex As String) As Long

    Public Declare Function CIPHER_Final _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function CIPHER_StreamUpdate _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpOutput As Byte, _
                                          ByRef lpData As Byte, _
                                          ByVal nDataLen As Long) As Long

    Public Declare Function CIPHER_StreamFinal _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    ' AEAD FUNCTIONS
    Public Declare Function AEAD_Encrypt _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
    ...
    Public Declare Function AEAD_InitKey _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal nKeyLen As Long, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function AEAD_SetNonce _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpNonce As Byte, _
                                          ByVal nNonceLen As Long) As Long

    Public Declare Function AEAD_AddAAD _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpAAD As Byte, _
                                          ByVal nAadLen As Long) As Long

    Public Declare Function AEAD_StartEncrypt _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    Public Declare Function AEAD_StartDecrypt _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpTagToCheck As Byte, _
    ...
    Public Declare Function AEAD_FinishEncrypt _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpTagOut As Byte, _
                                          ByVal nTagLen As Long) As Long

    Public Declare Function AEAD_FinishDecrypt _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    Public Declare Function AEAD_Destroy _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    ' GCM AUTHENTICATED EN/DECRYPTION FUNCTIONS
    ' Partly superseded by AEAD functions in [v5.1]
    Public Declare Function GCM_Encrypt _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutLen As Long, _
                                          ByRef lpTagOut As Byte, _
                                          ByVal nTagLen As Long, _
    ...
    Public Declare Function GCM_InitKey _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal nKeyLen As Long, _
                                          ByVal nOptions As Long) As Long
    ...
    Public Declare Function GCM_FinishKey _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function HASH_File _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutLen As Long, _
    ...
    Public Declare Function HASH_HexFromFile _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
                                          ByVal strFileName As String, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function HASH_HexFromHex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
    ...
    Public Declare Function HASH_Length _
                   Lib "diCryptoSys.dll" (ByVal nAlgId As Long) As Long  ' New in [v6.21]
    ...
    Public Declare Function HASH_AddBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nDataLen As Long) As Long

    Public Declare Function HASH_Final _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutLen As Long, _
                                          ByVal hContext As Long) As Long

    Public Declare Function HASH_DigestLength _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    Public Declare Function HASH_Reset _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    ' Stateful MAC functions added in [v6.0] (HMAC only)
    Public Declare Function MAC_Init _
                   Lib "diCryptoSys.dll" (ByRef lpKey As Byte, _
                                          ByVal nKeyLen As Long, _
                                          ByVal nAlg As Long) As Long

    Public Declare Function MAC_AddBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpMessage As Byte, _
                                          ByVal nMsgLen As Long) As Long

    Public Declare Function MAC_Final _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutLen As Long, _
                                          ByVal hContext As Long) As Long

    Public Declare Function MAC_CodeLength _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    Public Declare Function MAC_Reset _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    ' SECURE HASH ALGORITHM 1 (SHA-1)
    Public Declare Function SHA1_StringHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strData As String) As Long

    Public Declare Function SHA1_FileHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strFileName As String, _
                                          ByVal strMode As String) As Long

    Public Declare Function SHA1_BytesHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function SHA1_BytesHash _
                   Lib "diCryptoSys.dll" (ByRef lpDigest As Byte, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function SHA1_Init Lib "diCryptoSys.dll" () As Long

    Public Declare Function SHA1_AddString _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strData As String) As Long

    Public Declare Function SHA1_AddBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function SHA1_HexDigest _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal hContext As Long) As Long

    Public Declare Function SHA1_Reset _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function SHA1_HmacHex _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strHexData As String, _
                                          ByVal strHexKey As String) As Long

    ' SECURE HASH ALGORITHM (SHA-256)
    Public Declare Function SHA2_StringHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strData As String) As Long

    Public Declare Function SHA2_FileHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strFileName As String, _
                                          ByVal strMode As String) As Long

    Public Declare Function SHA2_BytesHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function SHA2_BytesHash _
                   Lib "diCryptoSys.dll" (ByRef lpDigest As Byte, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long
    ...
    Public Declare Function SHA2_AddString _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strData As String) As Long

    Public Declare Function SHA2_AddBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function SHA2_HexDigest _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal hContext As Long) As Long

    Public Declare Function SHA2_Reset _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function SHA2_HmacHex _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strHexData As String, _
                                          ByVal strHexKey As String) As Long
    ...
    ' SECURE HASH ALGORITHM (SHA-3)
    ' New in [v5.3]
    Public Declare Function SHA3_Init _
                   Lib "diCryptoSys.dll" (ByVal nHashBitLen As Long) As Long

    Public Declare Function SHA3_AddString _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strMessage As String) As Long

    Public Declare Function SHA3_AddBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nDataLen As Long) As Long

    Public Declare Function SHA3_HexDigest _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
                                          ByVal hContext As Long) As Long

    Public Declare Function SHA3_LengthInBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    Public Declare Function SHA3_Reset _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long

    ' RSA DATA SECURITY, INC. MD5 MESSAGE-DIGEST ALGORITHM
    Public Declare Function MD5_StringHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strData As String) As Long

    Public Declare Function MD5_FileHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strFileName As String, _
                                          ByVal strMode As String) As Long

    Public Declare Function MD5_BytesHexHash _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function MD5_BytesHash _
                   Lib "diCryptoSys.dll" (ByRef lpDigest As Byte, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long
    ...
    Public Declare Function MD5_AddString _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByVal strData As String) As Long

    Public Declare Function MD5_AddBytes _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function MD5_HexDigest _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal hContext As Long) As Long

    Public Declare Function MD5_Reset _
                   Lib "diCryptoSys.dll" (ByVal hContext As Long) As Long
    ...
    Public Declare Function MD5_HmacHex _
                   Lib "diCryptoSys.dll" (ByVal strDigest As String, _
                                          ByVal strHexData As String, _
                                          ByVal strHexKey As String) As Long
    ...
    Public Declare Function PC1_Hex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
                                          ByVal strInputHex As String, _
                                          ByVal strKeyHex As String) As Long

    Public Declare Function PC1_File _
                   Lib "diCryptoSys.dll" (ByVal strFileOut As String, _
                                          ByVal strFileIn As String, _
                                          ByRef lpKey As Byte, _
                                          ByVal nKeyLen As Long) As Long
    ...
    ' RANDOM NUMBER GENERATOR (RNG) FUNCTIONS
    Public Declare Function RNG_KeyBytes _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nBytes As Long, _
    ...
    Public Declare Function RNG_NonceData _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function RNG_NonceDataHex _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function RNG_Test _
                   Lib "diCryptoSys.dll" (ByVal strFileName As String) As Long

    Public Declare Function RNG_Number _
                   Lib "diCryptoSys.dll" (ByVal nLower As Long, _
                                          ByVal nUpper As Long) As Long

    Public Declare Function RNG_BytesWithPrompt _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
    ...
    Public Declare Function RNG_Initialize _
                   Lib "diCryptoSys.dll" (ByVal strSeedFile As String, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function RNG_MakeSeedFile _
                   Lib "diCryptoSys.dll" (ByVal strSeedFile As String, _
                                          ByVal strPrompt As String, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function RNG_UpdateSeedFile _
                   Lib "diCryptoSys.dll" (ByVal strSeedFile As String, _
                                          ByVal nOptions As Long) As Long
    ...
    ' ZLIB COMPRESSION FUNCTIONS
    Public Declare Function ZLIB_Deflate _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutputLen As Long, _
                                          ByRef lpInput As Byte, _
                                          ByVal nInputLen As Long) As Long

    Public Declare Function ZLIB_Inflate _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutputLen As Long, _
                                          ByRef lpInput As Byte, _
                                          ByVal nInputLen As Long) As Long
    ...
    ' HEX ENCODING CONVERSION FUNCTIONS
    ' See cnvHexStrFromBytes, cnvBytesFromHexStr, cnvHexFilter below
    Public Declare Function CNV_HexStrFromBytes _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function CNV_BytesFromHexStr _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutLen As Long, _
                                          ByVal strInput As String) As Long

    Public Declare Function CNV_HexFilter _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal nStrLen As Long) As Long

    ' BASE64 ENCODING CONVERSION FUNCTIONS
    ' See cnvB64StrFromBytes, cnvBytesFromHexB64, cnvB64Filter below
    Public Declare Function CNV_B64StrFromBytes _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal nMaxChars As Long, _
                                          ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    Public Declare Function CNV_BytesFromB64Str _
                   Lib "diCryptoSys.dll" (ByRef lpOutput As Byte, _
                                          ByVal nOutLen As Long, _
                                          ByVal strInput As String) As Long

    Public Declare Function CNV_B64Filter _
                   Lib "diCryptoSys.dll" (ByVal strOutput As String, _
                                          ByVal strInput As String, _
                                          ByVal nStrLen As Long) As Long

    ' CRC FUNCTIONS
    Public Declare Function CRC_Bytes _
                   Lib "diCryptoSys.dll" (ByRef lpInput As Byte, _
                                          ByVal nBytes As Long, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function CRC_String _
                   Lib "diCryptoSys.dll" (ByVal strInput As String, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function CRC_File _
                   Lib "diCryptoSys.dll" (ByVal strFileName As String, _
                                          ByVal nOptions As Long) As Long

    ' FUNCTIONS TO WIPE DATA
    Public Declare Function WIPE_File _
                   Lib "diCryptoSys.dll" (ByVal strFileName As String, _
                                          ByVal nOptions As Long) As Long

    Public Declare Function WIPE_Data _
                   Lib "diCryptoSys.dll" (ByRef lpData As Byte, _
                                          ByVal nBytes As Long) As Long

    ' Alternative Aliases to cope with Byte and String types explicitly...
    Public Declare Function WIPE_Bytes _
                   Lib "diCryptoSys.dll" _
                   Alias "WIPE_Data" (ByRef lpData As Byte, _
                                      ByVal nBytes As Long) As Long

    Public Declare Function WIPE_String _
                   Lib "diCryptoSys.dll" _
                   Alias "WIPE_Data" (ByVal strData As String, _
                                      ByVal nStrLen As Long) As Long
...
' }
'**/
Public Function cnvHexFromBytesMid(abData() As Byte, _
                                   nOffset As Long, _
...
'**/
Public Function cnvBytesMid(Bytes() As Byte, _
                            nOffset As Long, _
                            Optional nBytes As Long = -1) As Byte()
...
' }
'**/
Public Function errFormatErrorMessage(Optional nErrCode As Long = 0, _
                                      Optional szMsg As String = "") As String
...
'**/
Public Function aeadDecryptWithTag(lpData() As Byte, _
                                   lpKey() As Byte, _
                                   lpNonce() As Byte, _
                                   lpAAD() As Byte, _
                                   nOptions As Long) As Byte()
...
'**/
Public Function aeadEncryptWithTag(lpData() As Byte, _
                                   lpKey() As Byte, _
                                   lpNonce() As Byte, _
                                   lpAAD() As Byte, _
                                   nOptions As Long) As Byte()
...
'**/
Public Function cipherDecryptBytes(lpInput() As Byte, _
                                   lpKey() As Byte, _
                                   lpIV() As Byte, _
                                   szAlgModePad As String, _
                                   Optional nOptions As Long = 0) As Byte()
...
Public Function cipherDecryptBytes2(lpInput() As Byte, _
                                    lpKey() As Byte, _
                                    lpIV() As Byte, _
                                    szAlgModePad As String, _
                                    Optional nOptions As Long = 0) As Byte()
...
' @remark Default padding is `Pkcs5` for ECB and CBC mode and `NoPad` for all other modes.
'**/
Public Function cipherDecryptHex(szInputHex As String, _
...
' @remark Default padding is `Pkcs5` for ECB and CBC mode and `NoPad` for all other modes.
'**/
Public Function cipherEncryptBytes(lpInput() As Byte, _
                                   lpKey() As Byte, _
                                   lpIV() As Byte, _
                                   szAlgModePad As String, _
                                   Optional nOptions As Long = 0) As Byte()
...
Public Function cipherEncryptBytes2(lpInput() As Byte, _
                                    lpKey() As Byte, _
                                    lpIV() As Byte, _
                                    szAlgModePad As String, _
                                    Optional nOptions As Long = 0) As Byte()
...
' @remark Default padding is `Pkcs5` for ECB and CBC mode and `NoPad` for all other modes.
'**/
Public Function cipherEncryptHex(szInputHex As String, _
                                 szKeyHex As String, _
                                 szIvHex As String, _
                                 szAlgModePad As String, _
                                 Optional nOptions As Long = 0) As String
...
'**/
Public Function cipherFileEncrypt(szFileOut As String, _
...
' @remark `szFileOut` and `szFileIn` must __not__ be the same.
'**/
Public Function cipherFileDecrypt(szFileOut As String, _
                                  szFileIn As String, _
                                  lpKey() As Byte, _
                                  lpIV() As Byte, _
                                  szAlgModePad As String, _
...
'**/
Public Function cipherInit(fEncrypt As Integer, _
...
' @return Nonzero handle of the CIPHER context, or _zero_ if an error occurs.
'**/
Public Function cipherInitHex(fEncrypt As Integer, _
                              szAlgAndMode As String, _
                              szKeyHex As String, _
                              szIvHex As String, _
                              Optional nOptions As Long = 0) As Long
...
'**/
Public Function cipherKeyUnwrap(lpData() As Byte, _
                                lpKek() As Byte, _
                                nOptions As Long) As Byte()
...
'**/
Public Function cipherKeyWrap(lpData() As Byte, _
                              lpKek() As Byte, _
                              nOptions As Long) As Byte()
...
'**/
Public Function cipherStreamBytes(lpInput() As Byte, _
                                  lpKey() As Byte, _
                                  lpIV() As Byte, _
                                  nOptions As Long, _
                                  Optional nCounter As Long = 0) As Byte()
...
' }
'**/
Public Function cipherStreamHex(szInputHex As String, _
                                szKeyHex As String, _
                                szIvHex As String, _
                                nOptions As Long, _
                                Optional nCounter As Long = 0) As String
...
' @remark Note different order of parameters from core function.
'**/
Public Function cipherStreamFile(szFileOut As String, _
                                 szFileIn As String, _
                                 lpKey() As Byte, _
                                 lpIV() As Byte, _
                                 nOptions As Long, _
                                 Optional nCounter As Long = 0) As Long
...
' @remark Note different order of parameters from core function.
'**/
Public Function cipherStreamInit(lpKey() As Byte, _
                                 lpIV() As Byte, _
                                 nOptions As Long, _
                                 Optional nCounter As Long = 0) As Long
...
' }
'**/
Public Function hashHexFromBits(lpData() As Byte, _
                                nDataBitLen As Long, _
                                nOptions As Long) As String
...
' @return MAC value in hex-encoded format.
'**/
Public Function macHexFromBytes(lpMessage() As Byte, _
                                lpKey() As Byte, _
                                nOptions As Long) As String
...
' @return MAC value in hex-encoded format.
'**/
Public Function macHexFromHex(szMsgHex As String, _
                              szKeyHex As String, _
                              nOptions As Long) As String
...
'**/
Public Function padBytesBlock(lpInput() As Byte, _
                              nBlkLen As Long, _
                              Optional nOptions As Long = 0) As Byte()
...
' @return Padded data in byte array.
'**/
Public Function padHexBlock(szInput As String, _
                            nBlkLen As Long, _
                            Optional nOptions As Long = 0) As String
...
'**/
Public Function padUnpadBytes(lpInput() As Byte, _
                              nBlkLen As Long, _
                              Optional nOptions As Long = 0) As Byte()
...
' @remark An error is indicated by returning the _original_ data which will always be longer than the expected unpadded result.
'**/
Public Function padUnpadHex(szInput As String, _
                            nBlkLen As Long, _
                            Optional nOptions As Long = 0) As String
...
'**/
Public Function pbeKdf2(dkBytes As Long, _
                        lpPwd() As Byte, _
                        lpSalt() As Byte, _
                        nCount As Long, _
                        nOptions As Long) As Byte()
...
'**/
Public Function pbeKdf2Hex(dkBytes As Long, _
                           szPwd As String, _
...
' @return Key in byte array.
'**/
Public Function pbeScrypt(dkBytes As Long, _
                          lpPwd() As Byte, _
                          lpSalt() As Byte, _
                          nParamN As Long, _
                          nParamR As Long, _
...
' }
'**/
Public Function pbeScryptHex(dkBytes As Long, _
                             szPwd As String, _
                             szSaltHex As String, _
                             nParamN As Long, _
                             nParamR As Long, _
...
' @remark Note different order of parameters from core function.
'**/
Public Function prfBytes(nBytes As Long, _
                         lpMessage() As Byte, _
                         lpKey() As Byte, _
                         nOptions As Long, _
                         Optional szCustom As String = "") As Byte()
...
'**/
Public Function comprCompress(lpInput() As Byte, _
                              Optional nOptions As Long = API_COMPR_ZLIB) As Byte()
...
' @return Uncompressed data, or an empty array on error.
'**/
Public Function comprUncompress(lpInput() As Byte, _
                                Optional nOptions As Long = API_COMPR_ZLIB) As Byte()
...
'**/
Public Function blfBytesBlock(fEncrypt As Integer, _
                              lpInput() As Byte, _
                              lpKey() As Byte, _
                              lpIV() As Byte, _
                              Optional szMode As String = "ECB") As Byte()
