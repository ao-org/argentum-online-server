...
TRUNCATE TABLE ao_server_prod.mao__claims;
TRUNCATE TABLE ao_server_prod.mao__deals;
TRUNCATE TABLE ao_server_prod.mao__offers;
...
TRUNCATE TABLE ao_server_prod.whitelist;
