...
*   **`GetPatronTierFromAccountID(account_id As Long) As e_TipoUsuario`**: Queries the database to find the patron tier (e.g., Normal, Aventurero, Heroe, Leyenda, Noble, Emperador) associated with a given account ID.
